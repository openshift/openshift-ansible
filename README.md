...
- Install base dependencies:
  - Install [ansible 2.0](http://docs.ansible.com/ansible/intro_installation.htm).  See their documentation if 2.0 is not available in any available repo
  - Fedora:
  ```
  ...
  ```
   - OSX:
  ```
    # Install ansible 2.0 and python 2
