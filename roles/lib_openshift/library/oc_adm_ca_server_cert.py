...
options:
  state:
    description:
    - Present is the only supported state.  The state present means that `oc adm ca`
    - will generate a certificate and verify if the hostnames and the ClusterIP exists
    - in the certificate.
