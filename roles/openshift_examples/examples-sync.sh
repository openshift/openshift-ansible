...
RHDM_7_TAG=7.11.0.GA
RHPAM_7_TAG=7.11.0.GA
DG_VERSION=7.3-v1.0
...
mv rhdm-7-openshift-image-${RHDM_7_TAG}/rhdm711-image-streams.yaml ${EXAMPLES_BASE}/xpaas-streams/
mv rhpam-7-openshift-image-${RHPAM_7_TAG}/rhpam711-image-streams.yaml ${EXAMPLES_BASE}/xpaas-streams/
