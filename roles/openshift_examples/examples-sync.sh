...
mv rhdm-7-openshift-image-${RHDM_7_TAG}/rhdm75-image-streams.yaml ${EXAMPLES_BASE}/xpaas-streams/
mv rhpam-7-openshift-image-${RHPAM_7_TAG}/rhpam75-image-streams.yaml ${EXAMPLES_BASE}/xpaas-streams/
