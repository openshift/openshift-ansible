...
mv rhdm-7-openshift-image-${RHDM_7_TAG}/rhdm73-image-streams.yaml ${EXAMPLES_BASE}/xpaas-streams/
mv rhpam-7-openshift-image-${RHPAM_7_TAG}/rhpam73-image-streams.yaml ${EXAMPLES_BASE}/xpaas-streams/
