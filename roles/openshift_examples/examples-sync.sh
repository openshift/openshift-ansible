...
XPAAS_VERSION=ose-v1.4.17
RHDM_7_TAG=7.1.1.GA
RHPAM_7_TAG=7.1.1.GA
DG_72_VERSION=1.1.1
EAP_CD_BRANCH=eap-cd
EAP_72_BRANCH=eap72
...
wget https://github.com/jboss-container-images/jboss-eap-7-openshift-image/archive/${EAP_72_BRANCH}.zip -O jboss-eap-7-openshift-image-${EAP_72_BRANCH}.zip
wget https://github.com/jboss-container-images/jboss-eap-7-openshift-image/archive/${EAP_CD_BRANCH}.zip -O eap-cd-application-templates-${EAP_CD_BRANCH}.zip
unzip origin.zip
...
unzip jboss-eap-7-openshift-image-${EAP_72_BRANCH}.zip
unzip eap-cd-application-templates-${EAP_CD_BRANCH}.zip
...
mv jboss-eap-7-openshift-image-${EAP_72_BRANCH}/templates/eap72-image-stream.json ${EXAMPLES_BASE}/xpaas-streams/
mv jboss-eap-7-openshift-image-${EAP_CD_BRANCH}/templates/eap-cd-image-stream.json ${EXAMPLES_BASE}/xpaas-streams/
...
find jboss-eap-7-openshift-image-${EAP_72_BRANCH}/templates/ -name '*.json' ! -wholename '*image-stream*' -exec mv {} ${EXAMPLES_BASE}/xpaas-templates/ \;
find jboss-eap-7-openshift-image-${EAP_CD_BRANCH}/templates/ -name '*.json' ! -wholename '*image-stream*' -exec mv {} ${EXAMPLES_BASE}/xpaas-templates/ \;
rm ${EXAMPLES_BASE}/xpaas-templates/eap-cd-image-stream.json
popd
