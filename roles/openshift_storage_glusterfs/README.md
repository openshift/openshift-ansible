...
| openshift_storage_glusterfs_storageclass_volumetype    | Undefined               | Sets the volumetype parameter in the StorageClass, default is "replicate:3" which is the only supported value. Other possible values include "disperse:2:1" or "none".
