...
def test_short_version(predicates_lookup, short_version_fixture, regions_enabled, cloudprovider_enabled):
...
def test_deployment_type_kwarg(predicates_lookup, deployment_type_kwarg_fixture, regions_enabled, cloudprovider_enabled):
...
def test_short_version_deployment_type_kwargs(
        predicates_lookup, short_version_deployment_type_kwargs_fixture, regions_enabled, cloudprovider_enabled):
