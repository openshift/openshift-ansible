...
| openshift_hosted_router_seamless_reload | False                                  | Enable seamless reloads of haproxy router. See: [Openshift Docs](https://docs.openshift.com/container-platform/3.10/install_config/router/default_haproxy_router.html#preventing-connection-failures-during-restarts) |
