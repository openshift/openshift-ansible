...
Users may now deploy containerized versions of OpenShift Origin or OpenShift
Enterprise on Atomic Host[https://projectatomic.io] or RHEL, Centos, and Fedora.
This includes OpenvSwitch based SDN.
